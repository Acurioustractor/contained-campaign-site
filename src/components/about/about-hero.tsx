        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <h1 className="font-display text-5xl uppercase tracking-tight leading-none lg:text-6xl">
          ...
          <div className="space-y-6">
            <MediaPlayer
              ...
              src="https://your-project-id.supabase.co/storage/v1/object/public/videos/build/hero-video.mp4"
              poster="https://your-project-id.supabase.co/storage/v1/object/public/images/build/hero-poster.jpg"
